                  ...
                  {canUndo && (
                    <button
                      ...
                      className={`
                        ...
                        ${isRolling ? "bg-gray-300 text-gray-500 opacity-50 cursor-not-allowed shadow-none" : "bg-white text-rose-600 shadow-[4px_4px_0_0_#00183F] hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[6px_6px_0_0_#00183F]"}
                      `}
                    >
                      Desfazer
                    </button>
